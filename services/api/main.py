...
from services.api.routes import admin_stats, audio, auth, cameras, conversations, detection_models, digests, events, incidents, invites, journeys, notifications, observations, ollama_deploy, persons, providers, recordings, rules, search, summaries, system, timeline, transcripts, users
